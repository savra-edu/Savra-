...
export const CHAPTER_GRADE_REFERENCE: Record<string, Record<number, string[]>> = {
  ...
  HIST: {
    ...
    12: [
      ...
      "Nationalism, Partition and Independence",
    ],
  },
  GEO: {
    9: [
  ...
  HMUS: {
    11: [
      "हिंदुस्तानी संगीत की उत्पत्ति एवं विकास",
      "स्वर, श्रुति एवं सप्तक",
      "ठाठ एवं राग",
      "राग का लक्षण",
      "ताल एवं लय",
      "हिंदुस्तानी संगीत की शास्त्रीय गायन शैलियाँ",
      "संगीत की लिपि पद्धति",
      "भारतीय लोक संगीत",
    ],
    12: [
      "History and Development of Hindustani Music",
      "Expanded Swara, Shruti, Saptak Concepts",
      "Raga and Its Elaborations",
      "Advanced Lakshana of Ragas",
      "Expanded Tala and Laya Studies",
      "Classical Music Forms",
      "Notation and Composition Practices",
  ...
  IP: {
    ...
    12: [
      ...
      "Societal Impacts of IT and Ethics",
    ],
  },
  PSY: {
    11: [
  ...
  SOC: {
    11: [
      ...
      "Society, Social Structure and Social Stratification",
  ...
  LEGAL: {
    ...
    12: [
      ...
      "Topics in Law-I: Business and Contract",
  ...
  PE: {
    ...
    12: [
      ...
      "Physical Education and Sports for Persons with Special Needs",
