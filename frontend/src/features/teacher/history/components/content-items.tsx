...
export function ContentItem({ title, subtitle, badge, date, time }: ContentItemProps) {
  return (
    <div className="border-b border-gray-200 px-4 lg:px-6 py-4 lg:py-6 flex items-start justify-between bg-white lg:bg-[#FCF8FE] transition">
