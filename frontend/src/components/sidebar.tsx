...
import { Grid3x3Icon, BookOpenIcon, ListChecksIcon, BellIcon, BarChart3Icon, ClockIcon } from "lucide-react"
...
const navItems: NavItem[] = [
    { id: "home", label: "Home", icon: <Grid3x3Icon className="w-5 h-5" />, href: "/home" },
    {
        id: "lesson-planner",
